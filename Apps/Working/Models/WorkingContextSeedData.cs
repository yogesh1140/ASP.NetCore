...
{
    public class WorkingContextSeedData
    {
        private WorkingContext _context;
        private UserManager<WorkingUser> _userManager;

        public WorkingContextSeedData(WorkingContext context,UserManager<WorkingUser> userManager)
        {
            _context = context;
        ...
        {
            if (_userManager.FindByEmailAsync("working@working.com") == null)
            {
                var user = new WorkingUser()
                {
                    UserName = "working",
