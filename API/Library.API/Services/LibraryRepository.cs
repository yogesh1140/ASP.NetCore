    ...
    public class LibraryRepository : ILibraryRepository
    {
        ...
        public PagedList<Author> GetAuthors(AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            if (!string.IsNullOrEmpty(authorsResourceParameters.Genre))
            {
                ...
                collectionBeforePaging = collectionBeforePaging.Where(a => a.Genre.ToLowerInvariant().Trim() == genreForWhereClause);
            ...
            if (!string.IsNullOrEmpty(authorsResourceParameters.SearchQuery))
            {
                ...
                collectionBeforePaging = collectionBeforePaging.Where(c =>
                        c.Genre.ToLowerInvariant().Contains(searchQueryForWhereClause)
                        || c.FirstName.ToLowerInvariant().Contains(searchQueryForWhereClause)
                        || c.LastName.ToLowerInvariant().Contains(searchQueryForWhereClause));
            }
