    ...
    public class BooksRepository : IBooksRepository, IDisposable
    {
     ...
     //   }
        ...
        public async Task<IEnumerable<BookCover>> GetBookCoversAsync(Guid bookId)
        {
            ...
            var bookCoverUrls = new[]
            {
                $"http://localhost:4492/api/bookcovers/{bookId}-dummycover1",
                //$"http://localhost:4492/api/bookcovers/{bookId}-dummycover2?returnFault=true",
                $"http://localhost:4492/api/bookcovers/{bookId}-dummycover3",
                $"http://localhost:4492/api/bookcovers/{bookId}-dummycover4",
                $"http://localhost:4492/api/bookcovers/{bookId}-dummycover5"
            };
